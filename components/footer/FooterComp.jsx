...
export default function FooterComp() {
  ...
  return (
    <footer
      ref={elementRef}
      style={{ bottom: 0, transition: "all 0.5s easeInOut" }}
      className="fixed left-0 right-0 bg-white py-3 text-center dark:bg-transparent dark:text-white dark:backdrop-blur-lg dark:backdrop-filter max-sm:py-1"
    >
      <div className="m-auto flex max-w-7xl flex-wrap items-center justify-center">
        ...
        <div className="w-auto px-8 max-sm:mt-2">
          <div className="-m-1.5 flex flex-wrap">
            ...
            <div className="w-auto p-1.5">
              <a
                href="https://www.linkedin.com/in/hamza-shahzad1"
                target="_blank"
              >
                <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                  <svg
