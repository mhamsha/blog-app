...
// import { LogoComp } from "../index";
// import { Link } from "react-router-dom";

// function FooterComp() {
//   return (
//     <section className="relative overflow-hidden py-10 bg-slate-600 ">
//       <div className="relative z-10 mx-auto max-w-7xl px-4">
//         <div className="-m-6 flex flex-wrap">
//           <div className="w-full p-6 md:w-1/2 lg:w-5/12">
//             <div className="flex h-full flex-col justify-between">
//               <div className="mb-4 inline-flex items-center">
//                 <LogoComp textColor="text-white" />
...
//               <ul>
//                 <li className="mb-4">
//                   <a className=" text-base font-medium text-white hover:text-gray-300" href="#">
//                     Features
//                   </a>
//                 </li>
//                 <li className="mb-4">
          ...
          <div className="w-auto p-8">
            <div className="-m-1.5 flex flex-wrap">
              ...
              {/* <svg
                    ...
                    >
                      <path
                        d="M21.8,4.2l-9.8,6.1L2.2,4.2C2.1,4.1,2,4,1.9,4H22C21.9,4,21.9,4.1,21.8,4.2z M22,6.4v11.5c0,0.6-0.4,1-1,1h-3.6v-7.2l5.6-4.2V6.4z M14.4,11.7v7.2H9.6v-7.2L2,6.5l5.6-4.2l2.4,1.5c0.3,0.2,0.7,0.2,1,0l2.4-1.5l5.6,4.2L14.4,11.7z M2,18.8V6.4v-0.1l5.6,4.2v7.2H3C2.4,18.8,2,18.4,2,18.8z.2H3C2.4,18.8,2,18.4,2,18.8z"
                        fill="#EA4335"
                      ></path>
                    </svg>
                  </div>
